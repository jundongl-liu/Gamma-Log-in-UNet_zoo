...
class oilDataset(data.Dataset):
    def __init__(self, state, transform=None, target_transform=None):
        self.state = state
        self.train_root = "/home/jundongliu/UNET-ZOO-master/data/oil/train"
        self.val_root = "/home/jundongliu/UNET-ZOO-master/data/oil/val"
        self.test_root = "/home/jundongliu/UNET-ZOO-master/data/oil/test"
    ...
    def getDataPath(self):
        ...
        for i in range(n):
            i = i+1
            img = os.path.join(root, "%02d.png" % i)  # liver is %03d
            mask = os.path.join(root, "%02d_mask.png" % i)
            pics.append(img)
            masks.append(mask)
...
class newoilDataset(data.Dataset):
    def __init__(self, state, transform=None, target_transform=None):
        self.state = state
        self.train_root = "/home/jundongliu/UNET-ZOO-master/data/oil-spill-detection-dataset/train"
        self.val_root = "/home/jundongliu/UNET-ZOO-master/data/oil-spill-detection-dataset/val"
        self.test_root = "/home/jundongliu/UNET-ZOO-master/data/oil-spill-detection-dataset/test"
        self.pics,self.masks = self.getDataPath()
        self.transform =  transform 
        self.target_transform = target_transform
        """
...
class LiverDataset(data.Dataset):
    def __init__(self, state, transform=None, target_transform=None):
        self.state = state
        self.train_root = "/home/jundongliu/UNET-ZOO-master/data/liver/train"
        self.val_root = "/home/jundongliu/UNET-ZOO-master/data/liver/val"
